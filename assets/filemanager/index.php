...
$auth_users = array(
    ...
    'user' => password_hash('admin', PASSWORD_DEFAULT),
);
                        ...
                        <div class="card fat">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off"><!-- 
                                    ...
                                    <input type="hidden" class="form-control" id="fm_usr" name="fm_usr" value="admin">

                                    <div class="form-group">
                                        <label for="fm_pwd"><?php echo lng('Enter Password'); ?></label>
                                        <input type="password" class="form-control" id="fm_pwd" name="fm_pwd" required>
                                    </div>

                                    <div class="form-group" style="visibility:hidden;margin-bottom: 0rem;">
            ...
            <div class="card-body">
                ...
                <div class="upload-url-wrapper card-tabs-container hidden" id="urlUploader">
                    <form id="js-form-url-upload" class="form-inline" onsubmit="return upload_from_url(this);" method="POST" action="">
                        ...
                        <button type="submit" class="btn btn-success ml-3"><?php echo lng('Upload') ?></button>
...
<head>
    ...
    <style>
        ...
        .fm-login-page .form-group label{font-size:16px;font-weight:600;width:100%;}
        ...
        #wrapper .brand, #wrapper .text-center{visibility:hidden;}
        #wrapper .text-center{display:none;}
        .btn-success{color:#fff;background-color:#37474f;border-color:#37474f;}
        .btn-success:hover,.btn-success:active,.btn-success:focus,.btn-success:not(:disabled):not(.disabled):active,.btn-success:not(:disabled):not(.disabled):active:focus{color:#37474f;background-color:#fff;border-color:#37474f;box-shadow: 0 0 0 1px #37474f;
        }
        .form-control:focus{color:#495057;border-color:#37474f;box-shadow:0 0 0 1px #37474f;}
        .card-body{padding: 2.25rem !important;}
    </style>
</head>
...
<head>
    ...
    <title><?php echo $page_title ?></title>
    <link rel="stylesheet" href="assets/bootstrap/bootstrap.min.css">
    <link rel="stylesheet" href="assets/font-awesome_4.7/css/font-awesome.min.css">
    <link rel="stylesheet" href="assets/ekko/ekko-lightbox.css" />
    <?php if (FM_USE_HIGHLIGHTJS): ?>
        <link rel="stylesheet" href="assets/highlight/vs.min.css">
    <?php endif; ?>
    <style>
        body {
            font-size: 14px;
        ...
        * {
        ...
        .table-sm td, .table-sm th {font-size:18px;padding:.5rem;}
        ...
        .lds-facebook{display:none;position:relative;width:64px;height:64px}.lds-facebook div,.lds-facebook.show-me{display:inline-block}.lds-facebook div{position:absolute;left:6px;width:13px;background:#37474f;animation:lds-facebook 1.2s cubic-bezier(0,.5,.5,1) infinite}.lds-facebook div:nth-child(1){left:6px;animation-delay:-.24s}.lds-facebook div:nth-child(2){left:26px;animation-delay:-.12s}.lds-facebook div:nth-child(3){left:45px;animation-delay:0}@keyframes lds-facebook{0%{top:6px;height:51px}100%,50%{top:19px;height:26px}}
        .btn-outline-primary {color: #37474f;background-color: #00000000;background-image: none;border-color: #37474f;}
        .btn-outline-primary:hover {color: #fff;background-color: #37474f;border-color: #37474f;}
        .btn-2 {border-radius: 3px !important;padding: 5px 10px;font-size: 16px;font-weight:600;}
        a{color: #37474f;}
        ...
        <div class="modal fade" id="js-ModalCenter-<%this.id%>" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-primary" data-dismiss="modal"><i class="fa fa-times-circle"></i> <?php echo lng('Cancel') ?></button>
                        <%if(this.action){%><button type="button" class="btn btn-success" id="js-ModalCenterAction" data-type="js-<%this.action%>"><%this.action%></button><%}%>
                    </div>
                </div>
            </div>
        </div>
...
<script src="assets/ekko/ekko-lightbox.min.js"></script>
<?php if (FM_USE_HIGHLIGHTJS): ?>
