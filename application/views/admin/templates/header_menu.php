        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo base_url('dashboard');?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo base_url();?>assets/images/logo-sm.svg" alt="" height="30">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo base_url();?>assets/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">Admin</span>
                    </span>
                </a>
            ...
            <!-- App Search-->
            <form class="app-search d-none d-lg-block" style="visibility: hidden;">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block d-lg-none ms-2">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <form class="p-3" style="visibility: hidden;">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="<?php echo base_url();?>"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profile</a>                    
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="<?php echo base_url('auth/logout');?>"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> Logout</a>
                </div>
            </div>
