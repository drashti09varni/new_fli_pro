            ...
            <div class="row header">
                <div class="col-1">
                    <div class="menu-icon" id="back_btn">
                       <a href="<?php echo base_url();?>"><svg width="19" height="16" viewBox="0 0 19 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-2">
                    <div class="menu-logo">
                        <a href="<?php echo base_url();?>">
                            <img alt="menu" src="<?php echo base_url();?><?php echo $web_settings['logo'];?>" height="30px">
                        </a>
                    </div>
                </div>
                <div class="col-7">
                ...
                <div class="col-1">
                    <div class="menu-icon">
                        <svg width="16" height="16" viewBox="0 0 15 15" xmlns="external452e452e452e452e452e.html?link=http://www.w3.org/2000/svg">
                        ...
                        ?>
                           <tr>
                              <td class="Cs7ycL TcKeCe">
                                <a href="<?php echo base_url('single-products/');?><?php echo $v[0]['id'];?>">
                                    <div class="_2enssu">
                                        <div style="position:relative;min-height:110px;min-width:110px">
                                            <div class="_3LXIRu">
                                                <div class="_2GaeWJ" style="width:110px;height:110px">
                                                    <img class="_2puWtW _3a3qyb" src="<?php echo base_url().$v[0]['image'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="_24B_AU _3SexMn"><?php echo $v[0]['product_name'];?></div>
                                        <div class="_24B_AU _1AQnZC">
                                            <?php echo $v[0]['off_per'];?>% Off
                                            <span class="mrp">₹<?php echo $v[0]['cancle_price'];?></span>
                                        </div>
                                        <div class="_24B_AU _1AQnZC">
                                            <b class="selling-price">₹<?php echo $v[0]['price'];?></b>
                                            <img src="https://i.ibb.co/t4RsPCf/SwOvZ3r.png" width="77px">
                                        </div>
                              ...
                              <td class="Cs7ycL TcKeCe">
                                <a href="<?php echo base_url('single-products/');?><?php echo $v[1]['id'];?>">
                                    <div class="_2enssu">
                                        <div style="position:relative;min-height:110px;min-width:110px">
                                            <div class="_3LXIRu">
                                                <div class="_2GaeWJ" style="width:110px;height:110px">
                                                    <img class="_2puWtW _3a3qyb" src="<?php echo base_url().$v[1]['image'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="_24B_AU _3SexMn"><?php echo $v[1]['product_name'];?></div>
                                        <div class="_24B_AU _1AQnZC">
                                            <?php echo $v[1]['off_per'];?>% Off
                                            <span class="mrp">₹<?php echo $v[1]['cancle_price'];?></span>
                                        </div>
                                        <div class="_24B_AU _1AQnZC">
                                            <b class="selling-price">₹<?php echo $v[1]['price'];?></b>
                                            <img src="https://i.ibb.co/t4RsPCf/SwOvZ3r.png" width="77px">
                                        </div>
                                        <div class="_3Nxu4r delivery-txt">Free Delivery in Two Days</div>
                                    </div>
...
<div>
   <div class="_2uz0vJ">
      <div class="ftext"><img src="data:image/svg+xml;base64,"><a href="https://seller.flipkart.com/?utm_source=fkwebsite&amp;utm_medium=websitedirect"><span class="hDTmm5"> &nbsp;Become a Seller</span></a></div>
      <div class="ftext"><img src="data:image/svg+xml;base64,"><a href="https://brands.flipkart.com"><span class="hDTmm5"> &nbsp;Advertise</span></a></div>
      <div class="ftext"><img src="data:image/svg+xml;base64,"><a href="/the-gift-card-store?otracker=undefined_footer_footer_navlinks"><span class="hDTmm5"> &nbsp;Gift Cards</span></a></div>
      <div class="ftext"><img src="data:image/svg+xml;base64,"><a href="/helpcentre?otracker=undefined_footer_footer_navlinks"><span class="hDTmm5"> &nbsp;Help Center</span></a></div>
      <br>
      <div>
        <p class="z3ht-w p2222">© 2007-2023 <span>Flipkart.com</span></p>
        <img src="//static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/payment-method_69e7ec.svg" style="width: 100%;">
      </div>
   </div>
</div>    
</footer>

<script defer src="<?php echo base_url();?>assets/website/js/jquery.min.js"></script>
<script defer src="<?php echo base_url();?>assets/website/js/bootstrap.min.js"></script>
<!-- <script defer src="<?php echo base_url();?>assets/website/js/relativeTime.js"></script> -->
<!-- <script defer src="<?php echo base_url();?>assets/website/js/days.min.js"></script> -->
<!-- <script defer src="<?php echo base_url();?>assets/website/js/custom.js"></script> -->
<!-- <script defer src="<?php echo base_url();?>assets/website/js/manage_index.js"></script> -->
</body>
</html>