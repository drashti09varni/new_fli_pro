    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-12">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to <?php echo $title; ?>.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to <?php echo $title; ?>, accessible from <a href="https://<?php echo $site_link; ?>"
                                rel="external nofollow noopener" target="_blank">https://<?php echo $site_link; ?></a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By visiting this page on our website: <a href="https://<?php echo $site_link; ?>"
                            rel="external nofollow noopener" target="_blank">https://<?php echo $site_link; ?></a></li>
                </ul>
            </div>
        </div>
    </div>
